...
- [Правила разработки](Правила-разработки.md) - **ВАЖНО**: правила и приоритеты при написании кода
- [База знаний Python](База-знаний.md) - структурированная база знаний по Python с приоритетами использования
